...
mkdir -p ~/bin
sudo curl -o ~/bin/wlan0.mesh https://github.com/the-isf-academy/cs10_raspberrypiSetup/raw/master/mesh-network/wlan0.mesh
sudo curl -o ~/bin/setup-mesh-network.sh https://github.com/the-isf-academy/cs10_raspberrypiSetup/raw/master/mesh-network/setup-mesh-network.sh
sudo curl -o ~/bin/start-batman-adv.sh https://github.com/the-isf-academy/cs10_raspberrypiSetup/raw/master/mesh-network/start-batman-adv.sh
chmod +x start-batman.sh
sudo curl -o /etc/bat-hosts https://github.com/the-isf-academy/cs10_raspberrypiSetup/raw/master/mesh-network/bat-hosts
